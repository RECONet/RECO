#ifndef IOT_LOCATION_MESSAGE_H
#define IOT_LOCATION_MESSAGE_H
...
typedef struct iot_update_location_req_s {
...
} iot_update_location_req_t;

typedef struct iot_update_location_ans_s {
