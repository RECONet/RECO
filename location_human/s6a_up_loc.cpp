...
s6a_up_loc::s6a_ula_cb(
  ...
  s6a_update_location_ans_t              *s6a_update_location_ans_p = new s6a_update_location_ans_t;
...
s6a_up_loc::s6a_generate_update_location(
   ...
   */
  {
    ...
    unsigned char s[14] = "openair4G.eur";
    value.os.data = s;
    value.os.len = 13;
    CHECK_FCT(fd_msg_avp_setvalue(avp_p, &value));
    CHECK_FCT(fd_msg_avp_add(msg_p, MSG_BRW_LAST_CHILD, avp_p));
   ...
   */
  {
    ...
    PLMN_T_TO_TBCD(ulr_pP->visited_plmn, plmn, 2);
    value.os.data = plmn;
    value.os.len = 3;
    CHECK_FCT(fd_msg_avp_setvalue(avp_p, &value));
    CHECK_FCT(fd_msg_avp_add(msg_p, MSG_BRW_LAST_CHILD, avp_p));
