...
//static
int s1ap_mme_cxx::s1ap_mme_compare_plmn (
...
*/
//static
int s1ap_mme_cxx::s1ap_mme_compare_plmns (
...
*/
//static
int s1ap_mme_cxx::s1ap_mme_compare_tac (
...
*/
int s1ap_mme_cxx::s1ap_mme_compare_ta_lists (
