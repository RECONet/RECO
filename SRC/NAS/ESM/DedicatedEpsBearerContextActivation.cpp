  ...
  STOLEN_REF bstring *msg)
{
  ...
  bearer_context_t* bearer_context = mme_app_get_bearer_context(PARENT_STRUCT(emm_context, ue_mm_context_t, emm_context), ebi);
  ...
  *msg = NULL;
  ...
  if (rc != RETURNerror) {
     ...
     */
    rc = esm_ebr_start_timer (emm_context, ebi, msg_dup, nas_config.t3485_sec, _dedicated_eps_bearer_activate_t3485_handler);
  } else {
