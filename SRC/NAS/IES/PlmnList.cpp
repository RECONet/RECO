  ...
  uint32_t len)
{
  ...
  encoded++;
  *(buffer + encoded) = 0x00 | ((plmnlist->mccdigit2 & 0xf) << 4) | (plmnlist->mccdigit1 & 0xf);
  encoded++;
  *(buffer + encoded) = 0x00 | ((plmnlist->mncdigit3 & 0xf) << 4) | (plmnlist->mccdigit3 & 0xf);
  encoded++;
  *(buffer + encoded) = 0x00 | ((plmnlist->mncdigit2 & 0xf) << 4) | (plmnlist->mncdigit1 & 0xf);
  encoded++;
