...
AuthenticationResponseParameter::AuthenticationResponseParameter(bstring _authenticationresponseparameter) {
	authenticationresponseparameter = _authenticationresponseparameter;
}
...
void AuthenticationResponseParameter::dump (
  uint8_t iei)
{
