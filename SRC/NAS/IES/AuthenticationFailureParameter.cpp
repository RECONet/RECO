...
AuthenticationFailureParameter::AuthenticationFailureParameter(bstring _authenticationfailureparameter) {
	authenticationfailureparameter = _authenticationfailureparameter;
}
...
int AuthenticationFailureParameter::encode (
  uint8_t iei,
  uint8_t * buffer,
  uint32_t len)
{
  ...
  if ((encode_result = encode_bstring (authenticationfailureparameter, buffer + encoded, len - encoded)) < 0)
...
void AuthenticationFailureParameter::dump (
  uint8_t iei)
{
