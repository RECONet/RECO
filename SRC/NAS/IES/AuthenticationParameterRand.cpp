...
AuthenticationParameterRand::AuthenticationParameterRand(bstring _authenticationparameterrand) {
	authenticationparameterrand = _authenticationparameterrand;
}
...
int AuthenticationParameterRand::encode (
  uint8_t iei,
  uint8_t * buffer,
  uint32_t len)
{
...
void AuthenticationParameterRand::dump (
  uint8_t iei)
{
