...
AuthenticationParameterAutn::AuthenticationParameterAutn(bstring _authenticationparameterautn) {
	authenticationparameterautn = _authenticationparameterautn;
}
...
int AuthenticationParameterAutn::encode (
  uint8_t iei,
  uint8_t * buffer,
  uint32_t len)
{
...
void AuthenticationParameterAutn::dump (
  uint8_t iei)
{
