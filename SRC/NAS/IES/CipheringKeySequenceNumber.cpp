...
CipheringKeySequenceNumber::CipheringKeySequenceNumber(uint8_t _cipheringkeysequencenumber) {
	cipheringkeysequencenumber = _cipheringkeysequencenumber;
}
...
int CipheringKeySequenceNumber::decode (
  uint8_t iei,
  uint8_t * buffer,
  uint32_t len)
{
...
int CipheringKeySequenceNumber::decode_u8 (
  uint8_t iei,
  uint8_t value,
  uint32_t len)
{
...
int CipheringKeySequenceNumber::encode (
  uint8_t iei,
  uint8_t * buffer,
  uint32_t len)
{
...
uint8_t CipheringKeySequenceNumber::encode_u8 ()
{
...
void CipheringKeySequenceNumber::dump (
  uint8_t iei)
{
