  ...
  emm_sap_t * msg)
{
  ...
  if ((primitive > (emm_primitive_t) EMMREG_PRIMITIVE_MIN) && (primitive < (emm_primitive_t) EMMREG_PRIMITIVE_MAX)) {
     ...
     */
    msg->u.emm_reg.primitive = static_cast<emm_reg_primitive_t>(primitive);
     ...
     */
    msg->u.emm_esm.primitive = static_cast<emm_esm_primitive_t>(primitive);
     ...
     */
    msg->u.emm_as.primitive = static_cast<emm_as_primitive_t>(primitive);
     ...
     */
    msg->u.emm_cn.primitive = static_cast<emm_cn_primitive_t>(primitive);
