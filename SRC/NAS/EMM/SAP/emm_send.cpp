  ...
  attach_accept_msg * emm_msg)
{
  ...
  if (nas_config.t3412_min <= 31) {
    emm_msg->t3412value.unit = GPRS_TIMER_UNIT_60S;
    emm_msg->t3412value.timervalue = nas_config.t3412_min;
  } else  {
    emm_msg->t3412value.unit = GPRS_TIMER_UNIT_360S;
    emm_msg->t3412value.timervalue = nas_config.t3412_min / 6;
  }
  ...
  if (msg->t3402) {
    ...
    if (nas_config.t3402_min <= 31) {
      emm_msg->t3402value.unit = GPRS_TIMER_UNIT_60S;
      emm_msg->t3402value.timervalue = nas_config.t3402_min;
    } else  {
      emm_msg->t3402value.unit = GPRS_TIMER_UNIT_360S;
      emm_msg->t3402value.timervalue = nas_config.t3402_min / 6;
    }
  }
