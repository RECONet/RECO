 ...
 **                                                                        **
 ***************************************************************************/
void nas_network::nas_network_initialize (mme_config_t * mme_config_p, void *args_p)
{
   ...
   */
  nas_timer_init ();
  nas_obj->nas_proc_initialize (mme_config_p);
 ...
 **                                                                        **
 ***************************************************************************/
void nas_network::nas_network_cleanup (void *args_p)
{
  class nas_cxx *nas_obj = (class nas_cxx *)args_p;

  OAILOG_FUNC_IN (LOG_NAS);
  nas_obj->nas_proc_cleanup ();
  nas_timer_cleanup ();
  OAILOG_FUNC_OUT (LOG_NAS);
}
