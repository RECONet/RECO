 ...
 **                                                                        **
 ***************************************************************************/
void nas_procedure::nas_proc_initialize (
 ...
 **                                                                        **
 ***************************************************************************/
void nas_procedure::nas_proc_cleanup (
  void)
{
  OAILOG_FUNC_IN (LOG_NAS_EMM);
  /*
 ...
 **                                                                        **
 ***************************************************************************/
int nas_procedure::nas_proc_establish_ind (
 ...
 **                                                                        **
 ***************************************************************************/
int nas_procedure::nas_proc_dl_transfer_cnf (
 ...
 **                                                                        **
 ***************************************************************************/
int nas_procedure::nas_proc_dl_transfer_rej (
  const uint32_t ue_id,
  const nas_error_code_t status)
{
  OAILOG_FUNC_IN (LOG_NAS_EMM);
 ...
 **                                                                        **
 ***************************************************************************/
int nas_procedure::nas_proc_ul_transfer_ind (
  const mme_ue_s1ap_id_t ue_id,
  const tai_t originating_tai,
  const ecgi_t cgi,
  STOLEN_REF bstring *msg)
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_authentication_info_answer (
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_auth_param_res (
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_auth_param_fail (
    mme_ue_s1ap_id_t    ue_id,
    nas_cause_t         cause)
{
  OAILOG_FUNC_IN (LOG_NAS_EMM);
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_deregister_ue (
    mme_ue_s1ap_id_t ue_id)
{
  OAILOG_FUNC_IN (LOG_NAS_EMM);
  int                                     rc = RETURNerror;
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_pdn_config_res (
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_pdn_connectivity_res (
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_pdn_connectivity_fail (
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_create_dedicated_bearer(emm_cn_activate_dedicated_bearer_req_t * emm_cn_activate)
{
  OAILOG_FUNC_IN (LOG_NAS_EMM);
  int                                     rc = RETURNerror;
  emm_sap_t                               emm_sap;
  memset(&emm_sap, 0, sizeof(emm_sap_t));
  emm_sap.primitive = static_cast<emm_primitive_t>(_EMMCN_ACTIVATE_DEDICATED_BEARER_REQ);
...
//------------------------------------------------------------------------------
int nas_procedure::nas_proc_signalling_connection_rel_ind (mme_ue_s1ap_id_t ue_id)
{
  OAILOG_FUNC_IN (LOG_NAS_EMM);
  int                                     rc = RETURNerror;
  emm_sap_t                               emm_sap;
  memset(&emm_sap, 0, sizeof(emm_sap_t));
  emm_sap.primitive = static_cast<emm_primitive_t>(_EMMAS_RELEASE_IND);
...
/****************************************************************************/
nas_cause_t nas_procedure::s6a_error_2_nas_cause (
  uint32_t s6a_error,
  int experimental)
{
  if (experimental == 0) {
